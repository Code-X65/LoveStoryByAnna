...
const SignUpPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.gender) {
      setError('Please select who you are shopping for');
      return;
    }
      ...
      <div className="flex-1 flex items-center justify-center p-8 md:p-12 relative z-10 md:bg-white">
        <div className="w-full max-w-md bg-white/[0.8] md:bg-white md:bg-transparent p-8 md:p-0 rounded-2xl md:rounded-none">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Who are you shopping for? (Gender)
              </label>
              <select
                name="gender"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition text-sm"
                  disabled={loading}
                />
              </div>
              <div>
